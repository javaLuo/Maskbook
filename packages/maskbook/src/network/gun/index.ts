...
import type { _AsyncVersionOf, _AsyncGeneratorVersionOf } from '../../../node_modules/async-call-rpc/out/full'
...
export const GunAPI: _AsyncVersionOf<typeof import('./worker-implementation')> = AsyncCall({}, options) as any
export const GunAPISubscribe: _AsyncGeneratorVersionOf<typeof import('./worker-implementation-subscribe')> =
    AsyncGeneratorCall({}, options) as any
